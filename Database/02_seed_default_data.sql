...
-- DECLARE @PasswordResetBody NVARCHAR(MAX) = N'<html>Password reset...</html>';
...
USING (
    SELECT 
        ...
        N'You''ve been invited to join {{orgName}} on ChatarPatar' AS SubjectText,
